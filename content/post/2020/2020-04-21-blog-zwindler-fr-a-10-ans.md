---
title: blog.zwindler.fr a 10 ans
authors:
  - zwindler
type: post
date: 2020-04-21T06:40:00+00:00
excerpt: Les 10 ans de blog.zwindler.fr, rétrospective et perspectives.
...
En repensant à ça, je peux pas m’empêcher de sourire quand je vois des gens comme AtaxyaNetwork nous parler de "son DC" avec des paillettes dans les yeux (qui commence tout juste [son propre blog](https://blog.ataxya.net/)).
...
C’est comme ça que j’ai commencé à parler de [whiteboxing ESXi](/recherche/?keyword=whitebox), mon premier gros sujet de l’époque car je me suis cassé les dents pour faire marcher VMware sur du matoss "petit budget" (oui, ESXi était compatible avec à peu près rien à l’époque) et quasiment personne n’en parlait.

Aujourd’hui bien sûr, le blog est un peu différent. Je traite de sujet parfois plus _mainstream_ ([Jitsi par exemple](/recherche/?keyword=jitsi)), j’ai finalement écris quelques billets d’humeur alors que j’avais dis que je ne le ferai pas ([ici sur Cédric O](/2019/05/04/nomination-de-cedric-o-au-numerique-nouveau-monde-ou-sexisme-ordinaire/) ou [là sur le "Kubernetes bashing"](/2019/09/03/concerning-kubernetes-combien-de-problemes-ces-stacks-ont-generes/)) et un ou deux articles en anglais.

![](/2019/07/concerning_kubernetes.jpg)

## Upgrade de la salle serveur
  
Pendant longtemps, ma "salle serveurs" m’a permis de tester diverses technos, en particulier de bosser sur de la virtualisation grâce à mon hyperviseur et du stockage avec mon NAS fait maison (Synology, c’était trop cher pour moi en 2010). J’ai pu expérimenter sur [ESXi](/recherche/?keyword=esxi) puis [Proxmox](/recherche/?keyword=proxmox) pour le premier, les technos pour un [NAS](/recherche/?keyword=nas)/[MediaCenter](/recherche/?keyword=mediacenter) et [ZFS](/recherche/?keyword=zfs) pour le second.

J’ai aussi pu partager avec vous en 2014 la [conception 3D de mon "rack" perso](/recherche/?keyword=helmer), sur une inspiration du mythique "Red Helmer", faite avec Sketchup, des panneaux de MDF et beaucoup de peinture rouge.

![](/2014/03/meuble_v3red.png)
J’ai surtout découvert que penser l’airflow d’un boitier n’est pas si trivial qu’il n’y parait...


## Une nouvelle façon de travailler
  
En 10 ans, mine de rien, on peut dire que le métier de Sysadmin a beaucoup changé. En 2010, la virtualisation complète commençait juste à se généraliser en entreprise. On faisait du Windows, de l’Unix bien fermé, le tout supervisé avec du Nagios. Aujourd’hui, je bosse quasiment à 100% avec des technos open source (comme [Kube](/recherche/?keyword=kubernetes))

J’ai même pu contribuer (à mon petit niveau) à des projets comme [Ansible](/recherche/?keyword=ansible) et [XWiki](/recherche/?keyword=xwiki) que j’affectionne particulièrement.


![](/2017/06/xwiki_docker.png)
...
* [Retour d’expérience : 1 an à 90%](/2020/02/03/retour-dexperience-1-an-a-90/)
* [COVID-19 : Épidémie de ruptures de périodes d’essai](/2020/03/27/epidemie-de-ruptures-de-periodes-dessai/)
* [Syntec : le cadre au forfait jour](/2020/01/27/syntec-le-cadre-forfait-218-jours-en-2020/)
...
Dans les tiroirs, j’ai deux articles sur Nextcloud (que j’ai déjà teasé sur Twitter le mois dernier) et Jitsi prêts à sortir et planifiés. D’autres sujets que je n’ai pas encore traités ([Cryptpad](https://cryptpad.fr/)) ou que je voudrais approfondir encore (Helm, un bot Slack, ...) ne sont pas bien loin d’être finalisés aussi.
