---
title: 'Récap de la DevWorld Conference 2024'
authors:
  - zwindler
type: post
date: 2024-03-02T14:00:00+02:00
excerpt: Je suis pour la première fois participant à la DevWorld Conference, une conférence de développeurs à Amsterdam
...
* [greps.com - Accurately Measure Your  Coding Skills with GrepS](https://www.greps.com/)

### Climbing the product management career ladder

Ce talk de Nicole Van Alphen m'a beaucoup plu.

![](/2024/03/projectdirector.jpg)
...
En tant qu'[organisateur de KCD France](https://blog.zwindler.fr/2023/03/11/ma-premiere-experience-d-orga-kcd-france-2023/), j'ai eu cette problématique : j'étais responsable de l'enregistrement de quatre tables rondes où le son était difficile à maîtriser et où nous n’avons pas pu avoir de public. À garder en tête !
...
Claude a introduit le concept d'[OSPO](https://code.gouv.fr/fr/blog/definition-ospo/) (Open Source Program Office) pour gérer ces problématiques. Les OSPO sont des équipes au sein d'organisations qui sont responsables de jauger les projets utilisés dans l'entreprise, contribuer à ces projets et ainsi garantir leur pérennité, assurer un premier niveau de support pour les utilisateurs des logiciels open sources que l'entreprise utilise.
...
C'est un des seuls talks où j'ai réussi à [trouver les slides](https://github.com/Claudenw/cathedral-bazaar-coffeehouse) 🙃.
...
TL;DR: nginx ingress controller, c'est vraiment pourri jusqu'à la moelle (ok, j'exagère, mais je vous jure, je n'en peux plus de ce logiciel qui n'a rien à faire dans Kubernetes, cf [mon article Je déconseille nginx en tant qu'IngressController en production](https://blog.zwindler.fr/2022/11/14/je-deconseille-nginx-ingresscontroller-en-production/)).
...
J'ai eu une longue conversation avec [LeafCloud](https://www.leaf.cloud/), un cloud provider "green" qui utilise la chaleur des serveurs pour chauffer de l'eau et des bâtiments (même principe que [Qarnot](https://qarnot.com/fr), mais à une plus petite échelle). Ils proposent un Kubernetes Managé (au-dessus d'OpenStack) auquel on peut ajouter des GPUs que je ne manquerai pas de tester.

J'ai aussi discuté avec [ScyllaDB](https://www.scylladb.com/), [Cloudinary](https://cloudinary.com/), et d'autres. Ce n'étaient pas les sponsors que j'ai l'habitude de voir dans les conférences en France et c'était donc "rafraîchissant".
